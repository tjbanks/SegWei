...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /home/mizzou/Desktop/important/single_cell/BMTK_notebook/BMTK_notebook/sources/x86_64/kdrca1.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _la = alpn ( _threadargscomma_ _lv ) ;
   if ( _lv < - 55.0 ) {
     ...
     ninf = 1.0 / ( 1.0 + exp ( ( vhalfn - _lv ) / slop ) ) ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/important/single_cell/BMTK_notebook/BMTK_notebook/sources/modfiles/kdrca1.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
