...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nap /home/mizzou/Desktop/important/single_cell/BMTK_notebook/BMTK_notebook/sources/x86_64/Nap.mod\n");
...
static int  rates ( _threadargsproto_ ) {
 ...
 _lqt = pow( 2.3 , ( ( celsius - 21.0 ) / 10.0 ) ) ;
    mInf = 1.0 / ( 1.0 + exp ( ( v - mhalf ) / slope1 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/important/single_cell/BMTK_notebook/BMTK_notebook/sources/modfiles/Nap.mod";
static const char* nmodl_file_text = 
  ...
  "	RANGE gbar, g, ina,mhalf,slope1,mInf\n"
  "}\n"
  "\n"
  "UNITS	{\n"
  "	(S) = (siemens)\n"
  ...
  "\n"
  "	UNITSOFF\n"
  "		mInf = 1.0/(1+exp((v- mhalf)/slope1)) : assuming instantaneous activation as modeled by Magistretti and Alonso\n"
  "\n"
